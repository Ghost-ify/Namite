...
COOKIES_PER_SECOND = 3.5     # Each cookie allows ~210 requests per minute  
MIN_DELAY_BASE = 0.1         # Minimum delay between requests with one cookie
MIN_DELAY_MULTI = 0.05       # Minimum delay with multiple cookies
MAX_DELAY = 0.25            # Maximum delay between requests (on error)
